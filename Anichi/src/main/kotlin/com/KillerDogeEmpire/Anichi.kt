...
import com.RowdyAvocado.AnichiExtractors.invokeInternalSources
import com.RowdyAvocado.AnichiParser.AnichiLoadData
import com.RowdyAvocado.AnichiParser.AnichiQuery
import com.RowdyAvocado.AnichiParser.Detail
import com.RowdyAvocado.AnichiParser.Edges
import com.RowdyAvocado.AnichiParser.JikanResponse
import com.RowdyAvocado.AnichiUtils.aniToMal
import com.RowdyAvocado.AnichiUtils.getEpisode
import com.RowdyAvocado.AnichiUtils.getTracker
...
open class Anichi : MainAPI() {
    ...
    override val mainPage =
            mainPageOf(
                    """$apiUrl?variables={"search":{"sortBy":"Latest_Update","allowAdult":${settingsForProvider.enableAdult},"allowUnknown":false},"limit":26,"page":%d,"translationType":"sub","countryOrigin":"JP"}&extensions={"persistedQuery":{"version":1,"sha256Hash":"$mainHash"}}""" to
                            animeRecentTitle,
                    """$apiUrl?variables={"search":{"sortBy":"Latest_Update","allowAdult":${settingsForProvider.enableAdult},"allowUnknown":false},"limit":26,"page":%d,"translationType":"sub","countryOrigin":"CN"}&extensions={"persistedQuery":{"version":1,"sha256Hash":"$mainHash"}}""" to
                            donghuaRecentTitle,
                    """$apiUrl?variables={"type":"anime","size":30,"dateRange":1,"page":%d,"allowAdult":${settingsForProvider.enableAdult},"allowUnknown":false}&extensions={"persistedQuery":{"version":1,"sha256Hash":"$popularHash"}}""" to
                            popularTitle,
                    """$apiUrl?variables={"search":{"slug":"movie-anime","format":"anime","tagType":"upcoming","name":"Trending Movies"}}&extensions={"persistedQuery":{"version":1,"sha256Hash":"$slugHash"}}""" to
                            movieTitle
            )
    ...
    """
        ...
        val episodes =
                showData.availableEpisodesDetail.let {
    ...
    companion object {
        ...
        private const val slugHash =
                "bf603205eb2533ca21d0324a11f623854d62ed838a27e1b3fcfb712ab98b03f4"
